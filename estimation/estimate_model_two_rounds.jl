"""
Mapinator Model Parameter Estimator with Two-Round Theory
...
function main(; SEED=0)
    ...
    # upper bound on the alpha proportions
    ...
    sol_res = bboptimize(p -> chisquare(p, res.placements, k, K, M), SearchRange = [(0.0, upper[i]) for i in eachindex(upper)], MaxFuncEvals = 100000, TraceInterval = 5)
