...
def file_y_n():
    ...
    user=os.getenv("user");password=os.getenv("password");ref_token=os.getenv("ref_token");access_token=os.getenv("access_token")
...
def get_data(access_token): 
    ...
    #it would be wise not to change this code below, cuz these returns are important in the rest of the script
    try:
        slice[0]
    except:
        return 0
